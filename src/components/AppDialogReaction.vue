  ...
  >
    ...
    <div class="app-dialog--reaction-body">
      ...
      <div
        ...
        class="app-dialog--reaction__suggestions"
      >
        <div class="body-text-b3">
          <p>
            <strong>Unsere Vorschläge</strong>. Falls dein Grund nicht dabei
            sein sollte, nutze das Feld um dein Anliegen zu beschreiben
          </p>
        </div>
        <div class="app-dialog--reaction__suggestions-inner">
          <div
            class="app-dialog--reaction__suggestions-button"
            v-for="except in exceptions"
          >
            <ButtonType
