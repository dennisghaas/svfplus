...
const filteredUserData = computed(() => {
  const zusagenUsers = userData.value.filter(
    (user) =>
      user.username !== 'admin' &&
  ...
  const absagenUsers = userData.value.filter(
    (user) =>
      user.username !== 'admin' &&
      user.accessRights !== 'svf_commander' &&
      !props.playerWithNoAccess.includes(user.id.toString()) &&
  ...
  const unsicherUsers = userData.value.filter(
    (user) =>
      user.username !== 'admin' &&
      user.accessRights !== 'svf_commander' &&
      !props.playerWithNoAccess.includes(user.id.toString()) &&
  ...
  const keineReaktionUsers = userData.value.filter(
    (user) =>
      user.username !== 'admin' &&
      user.accessRights !== 'svf_commander' &&
      !props.playerWithNoAccess.includes(user.id.toString()) &&
